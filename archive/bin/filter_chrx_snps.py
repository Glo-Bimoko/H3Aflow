...
def fisher_exact_p(table):
    """Two-sided Fisher exact p-value for a 2x2 contingency table."""
    ...
    def prob(x):
        return (
            math.comb(row1, x) * math.comb(row2, col1 - x) / math.comb(total, row1)
        )
