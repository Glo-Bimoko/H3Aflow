...
# Determine if this is the raw PLINK file or the annotated file
if "COLLECTED_SEX" not in sexcheck.columns:
    # Raw PLINK output — annotate minimally
...
# ── Plot A: Sample QC – call rate distribution ────────────────────────────────
...
# ── Plot B: Sex check – F-statistic distribution ──────────────────────────────
fig, axes = plt.subplots(1, 2, figsize=(12, 4))
fig.suptitle("Sex Check – chrX F-Statistic", fontsize=12, fontweight="bold")

ax = axes[0]
for sex, grp in sexcheck.merge(sex_info[["IID","COLLECTED_SEX"]], on="IID", how="left").groupby("COLLECTED_SEX"):
...
<style>
  ...
  *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  footer {{
    ...
    font-size: 12px; padding: 20px 0 40px;
  }}
</style>
</head>
<body>
...
<div class="card" id="overview">
  ...
  <div class="card-body">
    <div class="params-grid">
      ...
      <div class="param-box">
        <div class="label">Samples Pass QC</div>
        <div class="value">{int(n_pass_any)}</div>
      </div>
      <div class="param-box">
        <div class="label">Uniquely Flagged</div>
        <div class="value">{len(flagged_agg)}</div>
      </div>
      <div class="param-box">
        <div class="label">Sex Discordant</div>
        <div class="value">{n_sex_discord}</div>
      </div>
      <div class="param-box">
        <div class="label">IBD Pairs Flagged</div>
        <div class="value">{n_ibd_pairs}</div>
      </div>
      <div class="param-box">
        <div class="label">PCA Outliers</div>
        <div class="value">{n_pca_outliers}</div>
      </div>
    </div>
    <br>
    ...
    <div class="params-grid">
      <div class="param-box">
        <div class="label">Missingness cutoff (--mind)</div>
        <div class="value">{args.mind}</div>
      </div>
      <div class="param-box">
        <div class="label">Het SD cutoff</div>
        <div class="value">±{args.het_sd} SD</div>
      </div>
      <div class="param-box">
        <div class="label">IBD PI_HAT threshold</div>
        <div class="value">{args.pi_hat}</div>
      </div>
    </div>
    <br>
...
<div class="card" id="sampleqc">
  ...
  <div class="card-body">
    ...
    <img class="plot-img" src="data:image/png;base64,{plot_sampleqc_b64}"
         alt="Sample QC plots">
  </div>
</div>
...
<div class="card" id="sexcheck">
  ...
  <div class="card-body">
    ...
    <img class="plot-img" src="data:image/png;base64,{plot_sexcheck_b64}"
         alt="Sex check plots">
  </div>
</div>
...
<div class="card" id="ibd">
  ...
  <div class="card-body">
    ...
    <img class="plot-img" src="data:image/png;base64,{plot_ibd_b64}"
         alt="IBD plots">
  </div>
</div>
...
<div class="card" id="pca">
  ...
  <div class="card-body">
    ...
    <img class="plot-img" src="data:image/png;base64,{plot_pca_b64}"
         alt="PCA plots">
  </div>
</div>
...
<footer>
  idat2vcf-pipeline QC Report &nbsp;·&nbsp; {now}
</footer>
